...
const DAYS: Day[] = [
  { num: "01", title: "diagnose", owner: "aakif", ownerRole: "seo + content", description: "Full 18-signal scan on your URL. Per-engine scoring across ChatGPT, Perplexity, Gemini, Claude. Competitive citation diff against 3 peers. Audit doc delivered by EOD.", ships: ["18-signal scorecard", "per-engine breakdown", "top 3 fix priorities ranked by delta"], deliverable: "audit doc + priority matrix", accent: false },
