...
const FAQ_CATEGORIES: FaqCategory[] = [
  {
    ...
    items: [
      ...
      { q: "how is the score calculated?", a: "18 signals across 4 blocks: A entity / identity (×1.5), B on-page structure (×1.0), C content depth (×1.0), D off-site distribution (×1.4). Raw max 115, normalised to /100. Each signal has a pass/fail criterion and a weight. The full rubric is published on /methodology - you can reconstruct any score from the published weights." },
